...
import { updateBias } from '@/app/lib/actions/biases';
import {
  UserCircleIcon,
  PencilIcon,
  CheckCircleIcon,
...
export default function EditBiasForm({ bias }: { bias: any }) {
  const initialState = { message: null, errors: {} };
  const updateBiasWithId = updateBias.bind(null, bias.id);
  const [state, dispatch] = useFormState(updateBiasWithId, initialState);
  ...
  return (
    <form action={dispatch}>
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                name="name"
                type="text"
                placeholder="Enter bias's full name"
                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
                aria-describedby="amount-error"
                defaultValue={bias.name}
                // required
              />
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  defaultChecked={bias.status === 'draft'}
                />
                <label
                  htmlFor="draft"
              ...
              <div className="flex items-center">
                <input
                  ...
                  defaultChecked={bias.status === 'finalized'}
                />
                <label
                  htmlFor="finalized"
              ...
              <div className="flex items-center">
                <input
                  ...
                  defaultChecked={bias.status === 'cancelled'}
                />
                <label
                  htmlFor="cancelled"
              ...
              <div className="flex items-center">
                <input
                  ...
                  defaultChecked={bias.status === 'in_progress'}
                />
                <label
                  htmlFor="in_progress"
              ...
              <div className="flex items-center">
                <input
                  ...
                  defaultChecked={bias.status === 'complete'}
                />
                <label
                  htmlFor="complete"
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit">Save Bias</Button>
      </div>
    </form>
  );
}
