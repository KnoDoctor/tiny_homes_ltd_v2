...
import { updateResponse } from '@/app/lib/actions/responses';
import {
  UserCircleIcon,
  PencilIcon,
  CheckCircleIcon,
...
export default function EditResponseForm({
  ...
  const updateResponseWithId = updateResponse.bind(null, response.id);
  const [state, dispatch] = useFormState(updateResponseWithId, initialState);
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              defaultValue={response.participant_id}
              // required
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              name="athleteId"
              className="peer block w-full cursor-pointer rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
              defaultValue={response.athlete_id}
              // required
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  defaultChecked={response.status === 'in_progress'}
                />
                <label
                  htmlFor="in_progress"
              ...
              <div className="flex items-center">
                <input
                  ...
                  defaultChecked={response.status === 'complete'}
                />
                <label
                  htmlFor="complete"
