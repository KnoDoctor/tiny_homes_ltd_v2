...
import { createBiasStatement } from '@/app/lib/actions/bias_statements';
...
import { AthleteField, BiasField } from '@/app/lib/definitions';
...
export default function Form({
  ...
  const [state, dispatch] = useFormState(createBiasStatement, initialState);
  ...
  return (
    <form action={dispatch}>
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit">Create Bias Statement</Button>
      </div>
    </form>
  );
}
