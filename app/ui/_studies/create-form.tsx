'use client';
import { BiasField, SportField } from '@/app/lib/definitions';
import Link from 'next/link';
import { Button } from '@/app/ui/button';
import { createStudy } from '@/app/lib/actions/studies';
...
export default function Form({
  ...
  const [state, dispatch] = useFormState(createStudy, initialState);
