...
import { createAthlete } from '@/app/lib/actions/athletes';
...
import { SportField } from '@/app/lib/definitions';

export default function Form({ sports }: { sports: SportField[] }) {
  const initialState = { message: null, errors: {} };

  const [state, dispatch] = useFormState(createAthlete, initialState);
