import { Revenue, SearchParam, SearchParams } from './definitions';
...
export const formatDateToLocal = (
  dateInput: Date | string, // Accept both Date and string types
  locale: string = 'en-US',
) => {
...
export function appendSearchParamsToUrl(
  ...
  // Ensure 'params' is indeed an array of 'SearchParam' objects
